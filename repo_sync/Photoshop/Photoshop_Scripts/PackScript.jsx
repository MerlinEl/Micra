...
//
//
// $Id: PackScript.jsx,v 1.73 2015/12/03 22:01:32 anonymous Exp $
...
Stdlib.RcsId = "$Id: PackScript.jsx,v 1.73 2015/12/03 22:01:32 anonymous Exp $";
...
Exec.log = function(msg) {
  ...
  if (!Exec.log.fptr) {
    ...
    Exec.log.fptr = file;
    msg = "Exec Versions $Revision: 1.73 $\n\n" + msg;
  } else {
    file = Exec.log.fptr;
    if (!file.open("e"))  {
