package net.xtools {
  ...
  public class Stdlib {
    public static var RcsId:String = "$Id: Stdlib.as,v 1.3 2009/11/11 22:33:13 anonymous Exp $";
   ...
   protected static var _inited:Boolean = Stdlib._init();
    ...
    public static function alert(msg:Object, win:Sprite=undefined):void {
      ...
      Alert.show(str, 'Message', 0x4, win);
      trace(str);
    }
    
    public static function writeToFile(f:*, s:*):void {
      if (!f || !s) {
        return;
      }
      var file:File = (f is File) ? f as File : new File(f);
      var str:FileStream = new FileStream();
      str.open(file, FileMode.WRITE);
      str.writeUTFBytes(s.toString());
    }
  }
}