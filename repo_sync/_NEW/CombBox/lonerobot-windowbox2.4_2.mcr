...
..............................................................................
	...
	Created By: Pete Addington
	Modified On: 14th November 2012
	Modified By: Pete Addington
	Tested using 
	3ds Max 2010 Sp1 x64
	3ds Max 2011 Sp1 x64
	3ds Max 2013 Sp5 x64

	<DESCRIPTION>
	A helper utility to retrive dialogs lost off when using a double monitor configuration and returning to single

	<VERSION_HISTORY>
	2.1 Added struct to dynamically build the icons from base64 encoded strings on first run. 
	2.2 Changed the window retrieval method to incorporate some missing dialogs
	2.3 Added Slate Material Editor access 
	2.4 Added global check for the Slate Interface (for pre max-2011)
	2.4.1 Added Maxscript Editor window to the HWND call
		Pre2011 SME check now unnecessary as getting handle via HWND (i.e. now done properly)
		Aligns dialog in the center of the main monitor
	2.4.2. Fixed bug with monitorinfo returning undefined 
	
*********************************************************************************************
CONTACT
*********************************************************************************************

	comments/bugs - pete@lonerobot.com 
	preferably the first one though
	
	Please read my technical articles at www.lonerobot.com
	
*********************************************************************************************
CONDITIONS OF USE
*********************************************************************************************
	Please let me know if you find this script useful in production or otherwise, it is always good to hear where my scripts are being used. It ready doesnt take two minutes to wrtie an email. 
	If I don't hear anything and I see 6 million downloads, then I'll sulk and throw my toys out of the pram. 
...
-- define the global for the struct and the rollout 
macroScript WindowBox
category:"LoneRobot"
toolTip:"WindowBox"
buttontext:"WinBox"
(
...
rollout WindowBox "WindowBox" width:520 height:0
		(	
		local AssetDir = ((getdir #scripts) + "\\LoneRobot\\Assets\\Icons\\")						
		local WindowIcon 
		local CloseIcon 
		local ResetIcon		
	...
	fn InitDataGrid data =
		...
		ResetIcon =   (dotNetclass "System.Drawing.image").fromfile (AssetDir + @"WBmove.png")	
			...
			ResizeColBanner.text = "Double-click the window icon on the left to reset window to screen top left"
			ResizeColBanner.forecolor = colorclass.lightgray
	 		...
	 		ResizeColBanner.font = dotNetObject "System.Drawing.Font" "Verdana" 7.0 ((dotNetClass "System.Drawing.FontStyle").bold)
