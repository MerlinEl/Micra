...
namespace Micra.Tools.Objects {
    ...
    /// </summary>
    public partial struct MxQuaternion {
        ...
        public MxQuaternion(double x, double y, double z, double w) {
            _x = x;
            _y = y;
            _z = z;
            _w = w;
        ...
        public MxQuaternion(MxVector axisOfRotation, double angleInDegrees) {
            ...
            MxVector v = ( axisOfRotation / length ) * Math.Sin(0.5 * angleInRadians);
            _x = v.X;
            _y = v.Y;
            _z = v.Z;
        ...
        ///     Identity quaternion
        /// </summary>
        public static MxQuaternion Identity {
            get {
                return s_identity;
            }
        }
        ...
        public MxVector Axis {
            ...
            get {
                ...
                if ( IsDistinguishedIdentity || ( _x == 0 && _y == 0 && _z == 0 ) ) {
                    return new MxVector(0, 1, 0);
                } else {
                    MxVector v = new MxVector(_x, _y, _z);
                    v.Normalize();
                    return v;
                }
            }
        ...
        public bool IsNormalized {
            get {
                ...
                return MxDoubleUtil.IsOne(norm2);
            }
        }
        ...
        public static MxQuaternion operator +(MxQuaternion left, MxQuaternion right) {
            if ( right.IsDistinguishedIdentity ) {
                if ( left.IsDistinguishedIdentity ) {
                    return new MxQuaternion(0, 0, 0, 2);
                } else {
                ...
                return new MxQuaternion(left._x + right._x,
                                      left._y + right._y,
                                      left._z + right._z,
                                      left._w + right._w);
            }
        ...
        /// <param name="right">Second quaternion being added.</param>
        /// <returns>Result of addition.</returns>
        public static MxQuaternion Add(MxQuaternion left, MxQuaternion right) {
            return ( left + right );
        }
        ...
        public static MxQuaternion operator -(MxQuaternion left, MxQuaternion right) {
            if ( right.IsDistinguishedIdentity ) {
                if ( left.IsDistinguishedIdentity ) {
                    return new MxQuaternion(0, 0, 0, 0);
                } else {
                    // We know left is not distinguished identity here.
                    left._w -= 1;
                    return left;
                ...
                // We know right is not distinguished identity here.
                return new MxQuaternion(-right._x, -right._y, -right._z, 1 - right._w);
            } else {
                return new MxQuaternion(left._x - right._x,
                                      left._y - right._y,
                                      left._z - right._z,
        ...
        /// <param name="right">Quaternion to subtract from the first quaternion.</param>
        /// <returns>Result of subtraction.</returns>
        public static MxQuaternion Subtract(MxQuaternion left, MxQuaternion right) {
            return ( left - right );
        }
        ...
        public static MxQuaternion operator *(MxQuaternion left, MxQuaternion right) {
            ...
            MxQuaternion result = new MxQuaternion(x, y, z, w);
            return result;
        ...
        /// <param name="right">Second quaternion.</param>
        /// <returns>Result of multiplication.</returns>
        public static MxQuaternion Multiply(MxQuaternion left, MxQuaternion right) {
            return left * right;
        }
        ...
        public static MxQuaternion Slerp(MxQuaternion from, MxQuaternion to, double t) {
        ...
        /// <returns>SLERP-interpolated quaternion between the two given quaternions.</returns>
        public static MxQuaternion Slerp(MxQuaternion from, MxQuaternion to, double t, bool useShortestPath) {
            ...
            if ( cosOmega > maxCosine ) {
                ...
                to = new MxQuaternion(-from.Y, from.X, -from.W, from.Z);
            ...
            return new MxQuaternion(scaleFrom * from._x + scaleTo * to._x,
        ...
        private static MxQuaternion GetIdentity() {
            // This code is called only once.
            MxQuaternion q = new MxQuaternion(0, 0, 0, 1);
        ...
        // Default identity
        private static MxQuaternion s_identity = GetIdentity();
