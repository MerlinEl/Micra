...
namespace Micra.Tools.Objects {
    ...
    /// </summary>
    public partial struct MxVector {
        ...
        public MxVector(double x, double y, double z) {
            _x = x;
            _y = y;
            _z = z;
        }
        ...
        #region Public 3DsMax Methods

        internal static MxVector FromIPoints(IPoint3 P1, IPoint3 P2) {
        ...
        internal static MxVector FromIPoint(IPoint3 p) => new MxVector(p.X, p.Y, p.Z);
        ...
        /// </returns>
        public static double AngleBetween(MxVector vector1, MxVector vector2) {
            vector1.Normalize();
            vector2.Normalize();
        ...
        public static MxVector operator -(MxVector vector) {
            return new MxVector(-vector._x, -vector._y, -vector._z);
        }
        ...
        public static MxVector operator +(MxVector vector1, MxVector vector2) {
            return new MxVector(vector1._x + vector2._x,
        ...
        /// <param name="vector2">Second vector being added.</param>
        /// <returns>Result of addition.</returns>
        public static MxVector Add(MxVector vector1, MxVector vector2) {
            return new MxVector(vector1._x + vector2._x,
                                vector1._y + vector2._y,
                                vector1._z + vector2._z);
        }
        ...
        /// <param name="vector2">Vector being subtracted.</param>
        /// <returns>Result of subtraction.</returns>
        public static MxVector Subtract(MxVector vector1, MxVector vector2) {
            return new MxVector(vector1._x - vector2._x,
                                vector1._y - vector2._y,
                                vector1._z - vector2._z);
        }
        ...
        /// <summary>
        /// Vector3D + MxPoint addition.
        /// </summary>
        /// <param name="vector">Vector by which we offset the point.</param>
        /// <param name="point">Point being offset by the given vector.</param>
        /// <returns>Result of addition.</returns>
        public static MxPoint operator +(MxVector vector, MxPoint point) {
            return new MxPoint(vector._x + point.X,
                               vector._y + point.Y,
                               vector._z + point.Z);
        }
        ...
        /// <param name="point">Point being offset by the given vector.</param>
        /// <returns>Result of addition.</returns>
        public static MxPoint Add(MxVector vector, MxPoint point) {
            return new MxPoint(vector._x + point.X,
                               vector._y + point.Y,
                               vector._z + point.Z);
        }
        ...
        /// <param name="point">Point being offset by the given vector.</param>
        /// <returns>Result of subtraction.</returns>
        public static MxPoint Subtract(MxVector vector, MxPoint point) {
            return new MxPoint(vector._x - point.X,
                               vector._y - point.Y,
                               vector._z - point.Z);
        }
        ...
        public static MxVector operator *(MxVector vector, double scalar) {
            return new MxVector(vector._x * scalar,
                                vector._y * scalar,
                                vector._z * scalar);
        }
        ...
        /// <param name="scalar">Scalar value by which the vector is multiplied.</param>
        /// <returns>Result of multiplication.</returns>
        public static MxVector Multiply(MxVector vector, double scalar) {
            return new MxVector(vector._x * scalar,
                                vector._y * scalar,
                                vector._z * scalar);
        }
        ...
        /// <param name="vector">Vector being multiplied.</param>
        /// <returns>Result of multiplication.</returns>
        public static MxVector operator *(double scalar, MxVector vector) {
            return new MxVector(vector._x * scalar,
                                vector._y * scalar,
                                vector._z * scalar);
        }
        ...
        /// <param name="vector">Vector being multiplied.</param>
        /// <returns>Result of multiplication.</returns>
        public static MxVector Multiply(double scalar, MxVector vector) {
            return new MxVector(vector._x * scalar,
                                vector._y * scalar,
                                vector._z * scalar);
        }
        ...
        /// <param name="scalar">Scalar value by which we divide the vector.</param>
        /// <returns>Result of division.</returns>
        public static MxVector Divide(MxVector vector, double scalar) {
            return vector * ( 1.0 / scalar );
        }
        ...
        /// <returns>Result of multiplication.</returns>
        /*public static MxVector operator *(MxVector vector, MxMatrix matrix) {
        ...
        /// <param name="matrix">Transformation matrix applied to the vector.</param>
        /// <returns>Result of multiplication.</returns>
        /*public static MxVector Multiply(MxVector vector, MxMatrix matrix) {
            return matrix.Transform(vector);
        }*/
        ...
        public static double DotProduct(MxVector vector1, MxVector vector2) {
        ...
        /// </summary>
        internal static double DotProduct(ref MxVector vector1, ref MxVector vector2) {
        ...
        public static MxVector CrossProduct(MxVector vector1, MxVector vector2) {
            MxVector result;
        ...
        /// vector1 and vector2 to a passed by ref for perf and ARE NOT MODIFIED
        /// </summary>
        internal static void CrossProduct(ref MxVector vector1, ref MxVector vector2, out MxVector result) {
        ...
        /// <summary>
        /// Vector3D to MxPoint conversion.
        /// </summary>
        /// <param name="vector">Vector being converted.</param>
        /// <returns>Point representing the given vector.</returns>
        public static explicit operator MxPoint(MxVector vector) {
            return new MxPoint(vector._x, vector._y, vector._z);
        }
        ...
        public static explicit operator MxSize(MxVector vector) {
