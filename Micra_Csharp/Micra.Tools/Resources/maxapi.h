...
class Interface : public FPStaticInterface {
	public:
		...
		/*! \deprecated Deprecated in 3ds Max 2013, use GetActiveViewExp instead.
		Returns the <b>ViewExp</b> pointer of the active MAX
		viewport. Remember to release the <b>ViewExp</b> pointer with
		<b>Interface::ReleaseViewport()</b>. */
		MAX_DEPRECATED ViewExp *GetActiveViewport(); // remember to release ViewExp* with ReleaseViewport()
...
#pragma warning( disable : 4481 )
		...
		virtual void PushPrompt( MCHAR *s ) sealed { PushPrompt(const_cast<const MCHAR*>(s)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void ReplacePrompt( MCHAR *s ) sealed { ReplacePrompt(const_cast<const MCHAR*>(s)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void DisplayTempPrompt( MCHAR *s, int msec) sealed { DisplayTempPrompt(const_cast<const MCHAR*>(s), msec); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void ChooseDirectory(HWND hWnd, MCHAR *title, MCHAR *dir, MCHAR *desc) sealed { 
			ChooseDirectory( hWnd, const_cast<const MCHAR*>(title), dir, desc);  }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual BOOL ProgressStart(MCHAR *title, BOOL dispBar, LPTHREAD_START_ROUTINE fn, LPVOID arg) sealed { 
			return ProgressStart(const_cast<const MCHAR*>(title), dispBar, fn, arg); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void ProgressUpdate(int pct, BOOL showPct, MCHAR *title) sealed {
			ProgressUpdate(pct, showPct, const_cast<const MCHAR*>(title)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void SetCurNamedSelSet(MCHAR *setName) sealed { SetCurNamedSelSet(const_cast<const MCHAR*>(setName)); }
#pragma warning( pop )
		...
		*/
		...
		/*! \deprecated Deprecated in 3ds Max 2013. Use GetViewExp instead.
		This method gets a viewport interface given a window handle.
		\par Parameters:
		<b>HWND hwnd</b>\n\n
		The window handle of the viewport. */
		MAX_DEPRECATED ViewExp *GetViewport( HWND hwnd );

		/*! \deprecated Deprecated in 3ds Max 2013. No longer needed.
		When the developer is done with the viewport interface
		...
		MAX_DEPRECATED void ReleaseViewport( ViewExp *vpt );	
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void FileSaveSelected(MCHAR *fname) sealed { FileSaveSelected(const_cast<const MCHAR*>(fname)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void FileSaveNodes(INodeTab* nodes, MCHAR *fname) sealed { FileSaveNodes(nodes,const_cast<const MCHAR*>(fname)); }
#pragma warning( pop )
		...
		/*! \deprecated Deprecated in 3ds Max 2013. Please use Interface::IsNetServer() instead. */
		MAX_DEPRECATED BOOL InSlaveMode() const;
		...
		*/
		...
		/** \deprecated Deprecated in 3ds Max 2013, please use Interface::IsNetworkRenderServer() instead, 
		which retains the same behaviour and semantics as this method. */
		MAX_DEPRECATED BOOL IsNetServer() const;
		...
		*/
		...
		/*! \deprecated Deprecated in 3ds Max 2013; there's no replacement for this method. */
		MAX_DEPRECATED void SetNetServer();
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void RAMPlayer(HWND hWndParent, MCHAR* szChanA, MCHAR* szChanB) sealed { RAMPlayer(hWndParent, const_cast<const MCHAR*>(szChanA), const_cast<const MCHAR*>(szChanB)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual int MAXScriptHelp(MCHAR* keyword) sealed { return MAXScriptHelp(const_cast<const MCHAR*>(keyword)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL SetDir(int which, MCHAR *dir) sealed { return SetDir(which, const_cast<const MCHAR*>(dir)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL AddAssetDir(MCHAR *dir, MaxSDK::AssetManagement::AssetType assetType, int update) sealed { 
		return AddAssetDir(const_cast<const MCHAR*>(dir), assetType, update); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL OpenSchematicViewWindow(MCHAR* sv_name) sealed { return OpenSchematicViewWindow(const_cast<const MCHAR*>(sv_name)); }
#pragma warning( pop )
	virtual BOOL SchematicViewZoomSelected(const MCHAR* sv_name) = 0;
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL SchematicViewZoomSelected(MCHAR* sv_name) sealed { return SchematicViewZoomSelected(const_cast<const MCHAR*>(sv_name)); }
#pragma warning( pop )
	virtual BOOL CloseSchematicView(const MCHAR* sv_name) = 0;
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL CloseSchematicView(MCHAR* sv_name) sealed { return CloseSchematicView(const_cast<const MCHAR*>(sv_name)); }
#pragma warning( pop )
	...
	/*! \deprecated Deprecated in 3ds Max 2013. Use GetViewExp instead. */
	MAX_DEPRECATED ViewExp *getViewport(int i);
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void LoadCUIConfig(MCHAR* fileName) sealed { LoadCUIConfig(const_cast<const MCHAR*>(fileName)); }
#pragma warning( pop )
...
public:
	...
	//! \deprecated Deprecated in 3ds Max2013, use Interface14::GetRendViewID() instead.
	//! \brief Returns the viewport index used, when the rendering is locked on a viewport
	/*  \see Interface7::getViewExp */
	MAX_DEPRECATED int GetRendViewIndex();
	//! \deprecated Deprecated in 3ds Max2013, use Interface14::SetRendViewID(int id) instead.
	...
	/*! If an invalid index is set, attempts to launch a render will fail and an error dialog will be displayed.
		...
		\see Interface7::getViewExp */
	MAX_DEPRECATED void SetRendViewIndex( int i );
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual ClassDesc *DoPickClassDlg(HWND hParent, MCHAR *title, SClass_ID super, PickClassCallback *pPickClassCB) sealed { 
		return DoPickClassDlg(hParent, const_cast<const MCHAR*>(title), super, pPickClassCB); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual int DoMultiplePickClassDlg(HWND hParent, MCHAR *title, SClass_ID super, PickClassCallback *pPickClassCB, Tab<ClassDesc *> *classDescTab) sealed { 
		return DoMultiplePickClassDlg(hParent, const_cast<const MCHAR*>(title), super, pPickClassCB, classDescTab); }
#pragma warning( pop )
