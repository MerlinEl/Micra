...
<b>#define NEVER Interval(TIME_NegInfinity, TIME_NegInfinity)</b>  */
    public class Interval : MaxHeapOperators {
    ...
    public CoreExport int InInterval(const TimeValue t) const;
    ...
    public int InInterval(const Interval interval) const { return InInterval(interval.Start() ) && InInterval(interval.End() );
}
/*! \remarks Returns 1 if the interval is <b>EMPTY</b>, i.e. has a
start and end time equal to <b>TIME_NegInfinity</b>. Returns 0
otherwise. */
public int Empty() { return ( start == TIME_NegInfinity ) && ( end == TIME_NegInfinity ); }
...
public void Set(TimeValue s, TimeValue e) { start = s; end = e; }
/*! \remarks Sets the start value only.
\par Parameters:
<b>TimeValue s</b>\n\n
Start time for the interval. */
public void SetStart(TimeValue s) { start = s; }
/*! \remarks Sets the end value only.
\par Parameters:
<b>TimeValue e</b>\n\n
End time for the interval. */
public void SetEnd(TimeValue e) { end = e; }

/*! \remarks Sets the interval to be <b>EMPTY</b>, i.e. having a start
and end time equal to <b>TIME_NegInfinity</b>. */
public void SetEmpty() { start = TIME_NegInfinity; end = TIME_NegInfinity; }
...
public void SetInfinite() { start = TIME_NegInfinity; end = TIME_PosInfinity; }
/*! \remarks Sets both the start and end times to the time passed. */
public void SetInstant(const TimeValue t) { start = end = t; }
/*! \remarks Returns the start time of the interval. */
public TimeValue Start() const { return start; }
		/*! \remarks Returns the end time of the interval. */
			public TimeValue End() const { return end; }
		/*! \remarks Implemented by the System.\n\n
		Returns the duration of the interval (end points included).
		\par Operators:
		*/
			public TimeValue Duration() const { return end-start+TimeValue(1); } // end points included
		...
		public CoreExport Interval operator &(const Interval i) const;
...
public Interval& operator&=(const Interval i) { return ( *this = ( *this & i ) ); }
/*! \remarks Expands the <b>Interval</b> to include the TimeValue.\n\n
<b>if (t\<start) start=t; if (t\>end) end=t; return *this;</b> */
public Interval& operator+=(const TimeValue t) { if ( t < start ) start = t; if ( t > end ) end = t; return *this; }
};
